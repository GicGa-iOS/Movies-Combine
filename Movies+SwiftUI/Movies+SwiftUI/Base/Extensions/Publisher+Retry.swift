...
extension Publisher {
    ...
    func retry<T, E>(_ strategy: @escaping ((E) -> RetryStrategy))
    ...
    func retry<T, E>(_ retries: Int, withDelay: @escaping ((E) -> Int))
    -> Publishers.TryCatch<Self, AnyPublisher<T, E>> where T == Self.Output, E == Self.Failure {
    ...
    func retry<T, E>(_ retries: Int, withDelay delay: Int, condition: ((E) -> Bool)? = nil)
    -> Publishers.TryCatch<Self, AnyPublisher<T, E>> where T == Self.Output, E == Self.Failure {
    ...
    func retry<T, E>(_ retries: Int, withBackoff initialBackoff: Int, condition: ((E) -> Bool)? = nil)
    -> Publishers.TryCatch<Self, AnyPublisher<T, E>> where T == Self.Output, E == Self.Failure {
